  ...
  return (
    <main className="max-w-[1920px] w-full mx-auto relative bg-background overflow-clip font-heading text-primary">
      ...
      <nav className="sticky top-6 z-50 mx-4 md:mx-[clamp(16px,2vw,38px)] flex flex-row justify-between items-center p-[15px] rounded-[16px] shadow-[inset_0_0_0_1px_#3d3a37] bg-background/80 backdrop-blur-md">
        ...
        <a href="#contact" className="flex flex-row items-center gap-2 p-2.5 bg-[#c96b8a] hover:bg-[#b45b78] rounded-[57px] hover:scale-105 transition-transform">
          <span className="text-[clamp(14px,1.25vw,22px)] font-bold text-white px-3">Liên hệ</span>
        </a>
      </nav>
      ...
      <motion.section
        ...
        <img className="w-full h-full object-cover shadow-[inset_0_0_0_1px_#3d3a37]" src={images.hero} alt="Không gian công nghệ" />
          ...
          <div className="flex flex-col gap-8">
            <motion.div
              ...
              <p className="text-[clamp(16px,1.3vw,22px)] font-normal leading-[1.7] text-primary">
                Tôi là <strong>Lưu Hoàng Vân Khánh</strong>, sinh viên ngành <strong>Ngôn ngữ Trung Quốc</strong>, ULIS-VNU. 
                Tôi đam mê các bộ phim Trung Quốc, văn hoá truyền Trung Quốc , luôn thích tìm tòi, học hỏi những điều mới để phát triển bản thân mỗi ngày.
              </p>
              <p className="text-[clamp(16px,1.3vw,22px)] font-normal leading-[1.7] text-primary">
                Sở thích của tôi bao gồm: học thư pháp, trải nghiệm ẩm thực Trung Quốc(như Tứ Xuyên, Quảng Đông,…), múa cổ trang và đọc sách về định hướng bản thân.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                  <div className="relative">
                    <img src={images.aboutPortrait} className="w-[100px] md:w-[141px] h-[100px] md:h-[141px] rounded-full object-cover shadow-[inset_0_0_0_1px_#3d3a37] z-[3] relative" alt="Ảnh chân dung" />
                  ...
                  <div className="flex flex-col gap-2 md:gap-4 text-center md:text-left">
                    <p className="text-[clamp(22px,2.08vw,40px)] font-bold text-primary">Lưu Hoàng Vân Khánh</p>
                    ...
                    <p className="text-[14px] md:text-[18px] font-bold text-primary">Sinh viên Ngôn ngữ Trung Quốc · Năm 1 · ULIS-VNU</p>
                  </div>
                </div>
              </div>
              <div className="flex flex-col gap-6">
                ...
                <p className="text-[clamp(16px,1.5vw,26px)] font-normal leading-[1.6] text-primary">
                  Môn học đã mở ra cho tôi cánh cửa bước vào thế giới công nghệ số, nơi mỗi kỹ năng đều trở thành hành trang cho tương lai. Từ việc sử dụng máy tính thành thạo, tìm kiếm và khai thác thông tin hiệu quả, đến việc tiếp cận trí tuệ nhân tạo và những công nghệ tiên tiến, tôi dần hình thành tư duy của một công dân số hiện đại. Bên cạnh đó, khả năng giao tiếp, hợp tác trực tuyến và sáng tạo nội dung số cũng được bồi đắp từng ngày. Trên hết, tôi nhận thức sâu sắc rằng an toàn thông tin và liêm chính học thuật không chỉ là nguyên tắc học tập mà còn là nền tảng để phát triển bền vững trong kỷ nguyên số.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            className="flex flex-col rounded-[20px] overflow-hidden shadow-[inset_0_0_0_1px_#3d3a37] bg-[#fdf0f3] hover:bg-[#f8e1e7] transition-all duration-300 group">
              ...
              <div className="p-6 flex flex-col gap-4 flex-1">
                <div>
                  ...
                  <p className="text-[clamp(14px,1.1vw,18px)] font-light leading-[1.6] text-primary/80">{assignment.goal}</p>
                </div>

                <div>
                  <p className="text-[13px] font-bold text-secondary uppercase tracking-widest mb-2">📋 Tóm tắt</p>
                  <p className="text-[clamp(14px,1.1vw,18px)] font-light leading-[1.6] text-primary/80">{assignment.summary}</p>
                </div>

                <div className="flex flex-wrap gap-2 mt-auto pt-2">
                  {assignment.tags.map((tag, j) =>
                <span key={j} className="py-1 px-3 rounded-full shadow-[inset_0_0_0_1px_#e8b2c5] text-[12px] font-bold text-secondary">
                      {tag}
                    </span>
                )}
                </div>
      ...
      <section id="set-up" className="mt-[clamp(38px,7.8vw,150px)] mx-4 md:mx-[clamp(16px,2.8vw,53px)] grid grid-cols-1 xl:grid-cols-[832fr_910fr] gap-[clamp(20px,5.2vw,100px)] z-10 relative">
        ...
        <div className="flex flex-col gap-[clamp(16px,3.2vw,62px)]">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[clamp(16px,1.5vw,24px)] font-normal leading-[1.6] text-primary/70">Những công cụ tôi sử dụng hàng ngày trong học tập và làm việc</p>
          </div>
        ...
        <div className="flex flex-col gap-8 relative">
          <motion.div
            ...
            <img src={images.setupMain} className="w-full h-full object-cover rounded-[20px] shadow-[inset_0_0_0_8px_#3d3a37] md:shadow-[inset_0_0_0_18px_#3d3a37]" alt="Không gian làm việc" />
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="w-full">
                ...
                <img src={src} className="w-full aspect-[270/164] object-cover rounded-[15px]" alt="Chi tiết thiết lập" />
              </motion.div>
            )}
          </div>
        </div>
            ...
            <motion.div
              ...
              className="flex flex-col gap-4 pt-6 border-t-[2px] border-primary/20 group cursor-pointer">
                ...
                <div className="flex flex-row flex-wrap gap-2">
                  {post.tags.map((tag, j) =>
                <span key={j} className="py-1 px-3 rounded-full shadow-[inset_0_0_0_1px_#e8b2c5] text-[12px] font-bold text-secondary">{tag}</span>
                )}
                  <span className="text-[13px] text-primary/50 font-light self-center ml-2">{post.date}</span>
                </div>
                <p className="text-[clamp(18px,1.5vw,26px)] font-extrabold group-hover:text-secondary transition-colors">{post.title}</p>
                <p className="text-[clamp(14px,1.2vw,20px)] font-light leading-[1.7] text-primary/70">{post.excerpt}</p>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            <p className="text-[clamp(16px,1.4vw,24px)] font-normal leading-[1.8] text-primary/90">
              Nhìn lại hành trình hoàn thiện portfolio, tôi nhận ra mình đã đi xa hơn những gì từng nghĩ. Điều đọng lại không chỉ là những kiến thức về máy tính, AI hay môi trường số, mà còn là một cách tư duy mới: biết học hỏi, biết chọn lọc thông tin, biết sáng tạo và biết sử dụng công nghệ một cách có trách nhiệm. Mỗi bài học là một viên gạch nhỏ góp phần xây dựng nền tảng số vững chắc, giúp tôi tự tin hơn để thích nghi, đổi mới và sẵn sàng bước vào tương lai trong kỷ nguyên số.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            <div className="flex flex-col gap-4">
              {[
              { emoji: "🤖", text: "Bài học về trí tuệ nhân tạo giúp tôi nhận ra AI không chỉ là công cụ hỗ trợ, mà còn là người bạn đồng hành, mở ra những phương pháp học tập và làm việc thông minh, hiệu quả hơn trong kỷ nguyên số." },
              { emoji: "🛡️", text: "Chủ đề về an toàn thông tin và liêm chính học thuật giúp tôi hiểu rằng năng lực số không chỉ được đo bằng kỹ năng công nghệ, mà còn bằng ý thức trách nhiệm và đạo đức trong việc sử dụng, chia sẻ thông tin." },
              { emoji: "🎨", text: "Những trải nghiệm sáng tạo nội dung số đã giúp tôi rèn luyện tư duy sáng tạo, khả năng truyền đạt ý tưởng và biến những kiến thức khô khan thành các sản phẩm trực quan, sinh động và giàu giá trị." }].
              map((item, i) =>
              <div key={i} className="flex flex-row items-start gap-3 p-4 bg-[#fdf0f3] rounded-[12px]">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1220fr_582fr] gap-[clamp(16px,2.6vw,50px)] xl:gap-[clamp(20px,5.2vw,100px)]">
          ...
          <motion.div
            ...
            <form className="flex flex-col gap-[23px] w-full" onSubmit={(e) => e.preventDefault()}>
              ...
              <button type="submit" className="flex flex-row items-center gap-[11px] p-4 md:p-5 bg-[#c96b8a] hover:bg-[#b45b78] rounded-[58px] w-fit hover:scale-105 transition-transform mt-4">
      ...
      <footer className="mt-[clamp(38px,7.8vw,150px)] mx-4 md:mx-12 mb-12 flex flex-col lg:flex-row justify-between items-center gap-10 z-10 relative border-t border-primary/20 pt-10">
        <div className="flex flex-row items-center gap-[clamp(16px,2.1vw,40px)] md:gap-[clamp(19px,4.9vw,95px)]">
          ...
          <p className="text-[clamp(20px,2.34vw,45px)] font-extrabold">VÂN KHÁNH</p>
        </div>
