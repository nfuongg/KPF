export const assignments = [
  {
    ...
    pdfLink:
      "https://drive.google.com/file/d/113-RqqvYo-IVb96kwmMzOBiR9atNcPfM/view?usp=drive_link",
    goal: "Hiểu cấu tạo, chức năng của máy tính và các thiết bị ngoại vi thông dụng trong học tập và làm việc.",
    summary:
      "Thực hiện tìm hiểu các thành phần cơ bản của máy tính (CPU, RAM, ổ cứng…) và các thiết bị ngoại vi (bàn phím, chuột, máy in, máy chiếu…). Trình bày dưới dạng báo cáo có hình ảnh minh họa.",
    sections: [
      {
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            desc: "Ở cột bên trái, nhấp vào This PC, sau đó nhấp đúp vào một ổ đĩa không phải ổ hệ thống (ví dụ: ổ D: hoặc E:).",
          },
          {
            step: "03",
            title: "Tạo thư mục mới",
            desc: "Nhấp chuột phải vào một khoảng trống → chọn New → Folder. Đặt tên thư mục là ThucHanh_hotensinhvien.",
          },
          {
            step: "04",
            title: "Tạo tệp tin văn bản",
            desc: "Nhấp chuột phải vào khoảng trống → New → Text Document. Đặt tên là GhiChu.txt.",
          },
          {
            step: "05",
            title: "Đổi tên tệp tin",
            desc: "Nhấp chuột phải vào tệp GhiChu.txt → chọn Rename. Đổi tên thành GhiChuQuanTrong.txt.",
          },
          {
            step: "06",
            title: "Sao chép & Di chuyển",
            desc: "Thực hành Copy & Paste (Ctrl+C / Ctrl+V) và Cut & Paste (Ctrl+X / Ctrl+V) để quản lý tệp tin giữa các thư mục.",
          },
          {
            step: "07",
            title: "Xóa và Khôi phục",
            desc: "Xóa tệp (chuyển vào Recycle Bin), xóa vĩnh viễn (Shift+Delete), và khôi phục từ Thùng rác bằng tùy chọn Restore.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    pdfLink:
      "https://drive.google.com/file/d/1s0Zr844g21sTdElErDdQMtKRkUb4ccUf/view?usp=drive_link",
    goal: "Nắm vững kỹ năng tìm kiếm, đánh giá và sử dụng thông tin trên môi trường số một cách hiệu quả và có trách nhiệm.",
    summary:
      "Thực hành tìm kiếm thông tin trên internet với các công cụ tìm kiếm nâng cao, đánh giá độ tin cậy của nguồn tin và tổng hợp dữ liệu phục vụ học tập.",
    sections: [
      {
        title: "Chủ đề nghiên cứu",
        content: "Thực trạng và giải pháp nâng cao kỹ năng dịch thuật Trung - Việt cho sinh viên năm cuối Khoa Ngôn ngữ và Văn hóa Trung Quốc - ĐHQGHN trong kỷ nguyên trí tuệ nhân tạo (AI)."
      },
      {
        title: "10 tài liệu tham khảo liên quan",
        steps: [
          { step: "01", title: "Nguyễn Thị Minh Hồng (2019)", desc: "Nghiên cứu lỗi dịch thuật của sinh viên năm thứ 3 khoa Ngôn ngữ và Văn hóa Trung Quốc, Tạp chí Nghiên cứu Nước ngoài, tập 35, số 2. — Xếp hạng: Khá" },
          { step: "02", title: "Bành Hữu Loa (2015)", desc: "Một số phương pháp dịch thuật ngữ Hán - Việt, Tạp chí Ngôn ngữ và Đời sống. — Xếp hạng: Rất cao" },
          { step: "03", title: "Phạm Ngọc Hàm (2016)", desc: "Sự tương đồng và khác biệt về văn hóa giữa tiếng Hán và tiếng Việt, Tạp chí Nghiên cứu Nước ngoài, ĐHQGHN. — Xếp hạng: Khá" },
          { step: "04", title: "Trần Thị Thanh Mai (2021)", desc: "Ứng dụng công nghệ thông tin trong giảng dạy biên - phiên dịch tại Việt Nam, Tạp chí Khoa học Ngoại ngữ, số 65. — Xếp hạng: Cao" },
          { step: "05", title: "Cầm Tú Tài (2018)", desc: "Phân tích đối chiếu cấu trúc bổ ngữ kết quả trong tiếng Hán và tiếng Việt, Tạp chí Nghiên cứu Nước ngoài. — Xếp hạng: Rất cao" },
          { step: "06", title: "Bành Hữu Loa (2014)", desc: "Giáo trình Lý thuyết dịch Hán - Việt. Hà Nội: NXB Đại học Quốc gia Hà Nội. — Xếp hạng: Rất cao" },
          { step: "07", title: "Phạm Ngọc Hàm (2013)", desc: "Tiếng Hán hiện đại - Những vấn đề về từ vựng và ngữ pháp. Hà Nội: NXB Đại học Quốc gia Hà Nội. — Xếp hạng: Rất cao" },
          { step: "08", title: "Nguyễn Thượng Hùng (2005)", desc: "Dịch thuật: Từ lý thuyết đến thực hành. Hà Nội: NXB Văn hóa Thông tin. — Xếp hạng: Rất cao" },
          { step: "09", title: "Kỷ yếu Hội thảo quốc tế (2022)", desc: "Nghiên cứu và giảng dạy tiếng Hán trong bối cảnh chuyển đổi số. Hà Nội: NXB Đại học Quốc gia Hà Nội. — Xếp hạng: Rất cao" },
          { step: "10", title: "ĐH Ngoại ngữ - ĐHQGHN (2023)", desc: "Báo cáo tổng kết hoạt động nghiên cứu khoa học sinh viên năm học 2022-2023. — Xếp hạng: Rất cao" },
        ]
      },
      {
        title: "Đánh giá & xếp hạng độ tin cậy nguồn tin",
        highlights: [
          { emoji: "📄", text: "5 bài báo khoa học — đối chiếu ngôn ngữ, khảo sát thực tế trên sinh viên ULIS, xếp hạng từ Khá đến Rất cao" },
          { emoji: "📘", text: "3 sách chuyên khảo — do Phó Giáo sư, Tiến sĩ tại ULIS - ĐHQGHN biên soạn, được hội đồng khoa học thẩm định khắt khe, xếp hạng Rất cao" },
          { emoji: "🏛️", text: "2 tài liệu hội thảo/báo cáo — xuất bản bởi ĐHQGHN, đơn vị đầu ngành ngoại ngữ tại Việt Nam, xếp hạng Rất cao" },
        ]
      },
      {
        title: "Kết quả",
        content: "Thu thập được 10 tài liệu tham khảo trực tiếp liên quan đến kỹ năng dịch thuật Trung - Việt, gồm 5 bài báo khoa học, 3 sách chuyên khảo và 2 tài liệu hội thảo/báo cáo. 7/10 nguồn đạt mức độ tin cậy Rất cao nhờ uy tín tác giả (giảng viên, Phó Giáo sư, Tiến sĩ tại ULIS - ĐHQGHN) và đơn vị xuất bản uy tín, tạo nền tảng vững chắc cho nghiên cứu thực trạng và giải pháp nâng cao kỹ năng dịch thuật trong kỷ nguyên AI."
      }
    ],
  },
  {
  ...
  },
  {
    ...
    pdfLink:
      "https://drive.google.com/file/d/17Mq5zJE-LU3bqF2ZYR87EC3eH_16XyRy/view?usp=drive_link",
